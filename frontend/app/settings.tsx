...
// Presets for quick selection - 4 goal-oriented options
const PRESETS = [
  {
    key: 'weight_loss',
    label: 'Abnehmen',
    description: 'Kalorien & Gewicht im Fokus',
    icon: 'trending-down',
    color: '#FF6B6B',
    settings: {
      track_calories: true,
  ...
  },
  {
    key: 'muscle_building',
    label: 'Muskelaufbau',
    description: 'Protein & Training tracken',
    icon: 'barbell',
  ...
  },
  {
    ...
    label: 'Gesünder leben',
    description: 'Schlaf, Wasser & Bewegung',
    icon: 'leaf',
    color: '#2ECC71',
    settings: {
  ...
  },
  {
    key: 'all',
    label: 'Alles tracken',
    description: 'Für Detailverliebte',
    icon: 'checkmark-done',
    color: COLORS.accent,
    settings: {
      track_calories: true,
