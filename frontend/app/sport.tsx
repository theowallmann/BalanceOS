...
const styles = StyleSheet.create({
  ...
  aiGenerateButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.accent, padding: 14, borderRadius: 12, gap: 8, marginBottom: 20, marginTop: 16 },
  ...
  suggestionCard: { backgroundColor: COLORS.surfaceLight, borderRadius: 12, padding: 16, marginBottom: 12 },
  suggestionHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 8 },
  suggestionTitle: { fontSize: 18, fontWeight: '700', color: COLORS.text, flex: 1 },
  suggestionDesc: { fontSize: 14, color: COLORS.textSecondary, lineHeight: 20, marginBottom: 12 },
  suggestionMeta: { flexDirection: 'row', gap: 16 },
  suggestionMetaText: { fontSize: 14, color: COLORS.primary, fontWeight: '600' },
  suggestionHint: { fontSize: 12, color: COLORS.accent, marginTop: 8, textAlign: 'center' },
});
